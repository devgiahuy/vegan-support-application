...
import { Leaf, Menu, Search, Bell, Sparkles, X, User as UserIcon, LogOut } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Khám phá món', href: '/cong-thuc' },
  { label: 'Cẩm nang', href: '/bai-viet' },
  { label: 'Thực đơn tuần', href: '/ke-hoach-bua-an' },
  { label: 'Bản đồ quán', href: '/ban-do' },
  { label: 'Hỏi AI', href: '/tro-ly-ai' },
];
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/70 bg-background/85 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 lg:px-6">
        <Link href="/" className="flex shrink-0 items-center gap-2">
          ...
          <span className="text-lg font-bold tracking-tight text-primary">ChayXanh</span>
        </Link>
